...
class AdvSearchCategoryAdapter(private val categories: Array<String>): RecyclerView.Adapter<AdvSearchCategoryAdapter.CategoryViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.adv_search_category_item, parent, false)
